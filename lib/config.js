...
class Configuration {
  ...
  load () {
    ...
    this.config = {
      ...
      importProjectKey: process.env.CTP_IMPORT_PROJECT_KEY,
      importClientId: process.env.CTP_IMPORT_CLIENT_ID,
      importClientSecret:
        process.env.CTP_IMPORT_CLIENT_SECRET,
      importAuthUrl: this.normalizeUrl(
        process.env.CTP_IMPORT_AUTH_URL
      ),
      importApiUrl: this.normalizeUrl(
        process.env.CTP_IMPORT_API_URL
      )
    }
  }
